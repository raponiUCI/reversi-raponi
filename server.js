...
io.on('connection', (socket) => {
    ...
    */
    /* join_room response:
         {
             ...
             'count: the numnber of users in the chat room
        ...
        io.in(room).fetchSockets().then((sockets) => {
            ...
            /* Socket did join the room */
                ...
                for (const member of sockets){
                    ...
                    /* Tell everyone that a new username has joined the chat room */
    ...
    socket.on('invite', (payload) => {
        ...
        /* make sure the invtied player is present */
    ...
    socket.on('game_start', (payload) => {
        ...
        /* make sure the invtied player to engage is present */
        io.in(room).allSockets().then((sockets) => {
        ...
        if (sockets.size >= 1) {
            ...
            if ((games[game_id].player_white.socket != first) && (games[game_id].player_black.socket != first)) {
                ...
                if (games[game_id].player_white.socket === "") {
                    ...
                    console.log("White has been assigned to: " + first);
                    ...
                    console.log("Black has been assigned to: " + first);
